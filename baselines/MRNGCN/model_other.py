...
class CNN(torch.nn.Module):
    def __init__(self, input_dims):#(self)
        super(CNN, self).__init__()
        self.conv1 = nn.Conv1d(in_channels=input_dims, out_channels=64, kernel_size=1)#in_channels=128
...
class MLP(torch.nn.Module):
    def __init__(self, input_dims):
        ...
        self.lin1 = Linear(input_dims, 128)#64     # pan-cancer
